...
/**
 * Clase donde definimos las capacidades para la recepción y envío de mensajes,
 */
public class Utils {
	...
	protected static DFAgentDescription [] buscarAgentes(Agent agent, String tipo) {
		...
		// Indico las carac. del tipo de servicio que quiero encontrar
	...
	/**
	 * Envio de un objeto desde el agente indicado a un agente que proporciona un servicio del tipo dado
...
//				JOptionPane.showMessageDialog(null, "Agente "+ getLocalName() +" no encontro ningun servicio buscador", "Error",JOptionPane.INFORMATION_MESSAGE);
	...
	public static File abrirFichero(String ruta) {
        ...
        catch (NullPointerException e) { System.out.println("No se ha seleccionado ning�n fichero"); } 
